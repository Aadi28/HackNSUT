...
public class MainActivity extends AppCompatActivity {
    ...
    private ActionProcessButton btnGenerateOtp,btnLogin;
    Button btnGenerateNewOtp;
...
//        bar.setDisplayUseLogoEnabled(true);
        ...
        btnGenerateOtp=(ActionProcessButton) findViewById(R.id.btnGenerateOTP);
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallback= new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
            ...
            btnGenerateOtp.setMode(ActionProcessButton.Mode.PROGRESS);
            btnGenerateOtp.setProgress(25);
            btnGenerateOtp.setProgress(50);
            btnGenerateOtp.setProgress(75);
            btnGenerateOtp.setMode(ActionProcessButton.Mode.ENDLESS);
